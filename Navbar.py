...
class Navbar(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        self.encryption_button = tk.Button(self, text="Encryption",
                                           command=lambda: self.parent.switch_frame(EncryptionPage))
        self.encryption_button.grid(row=0, column=1, padx=5)

        self.decryption_button = tk.Button(self, text="Decryption",
                                           command=lambda: self.parent.switch_frame(DecryptionPage))
